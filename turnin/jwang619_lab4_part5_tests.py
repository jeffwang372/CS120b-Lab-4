...
tests = [ {'description': 'PINA: 0x00, 0x04, 0x00, 0x01, 0x00, 0x02, 0x00, 0x07, 0x00 => PORTB: 0x00',
    'steps': [{'inputs': [('PINA', 0x00)], 'iterations': 100},
	...
	{'inputs': [('PINA', 0x00)], 'iterations': 100},
	{'inputs': [('PINA', 0x07)], 'iterations': 100},
	{'inputs': [('PINA', 0x00)], 'iterations': 100}],
    'expected': [('PORTB',0x00)],
    },
    {'description': 'PINA: 0x80 => PORTB: 0x00',
    'steps': [{'inputs': [('PINA', 0x80)], 'iterations': 100}],
    'expected': [('PORTB',0x00)],
    },
    ]
watch = ['SMState']
